...
docker build -t bipca-experiment:$new_version --build-arg GITHUB_PAT=$GITHUB_PAT --target=$STAGE -f dockerfiles/bipca-base0.03.dockerfile  . > bipca-experiment:$new_version.log && echo "Build completed"
