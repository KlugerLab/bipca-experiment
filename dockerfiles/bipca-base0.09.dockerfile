...
FROM continuumio/miniconda3:22.11.1 AS python
...
COPY ./bipca-experiment/runNormalization.py /bipca-experiment/runNormalization.py
RUN ln -s /bipca-experiment/runNormalization.py /opt/conda/bin/runNormalization.py
